...
var getChildState = exports.getChildState = function getChildState(nodes) {
  var all = true;
  var none = true;
  var allWithoutDisable = true;
  var allDisabled = nodes.length > 0;
  ...
  return { all: all, none: none, allWithoutDisable: allWithoutDisable, half: anyIndeterminate || anyChecked && (anyDisabled || anyUnchecked), allDisabled: allDisabled };
};
        ...
        var handleDescendants = function handleDescendants() {
          if (deep) {
            ...
            var _getChildState3 = getChildState(childNodes),
                ...
                _allWithoutDisable = _getChildState3.allWithoutDisable,
                allDisabled = _getChildState3.allDisabled;

            if (!_all) {
              _this3.checked = _allWithoutDisable;
            }
            if (allDisabled) {
              _this3.checked = false;
            }
